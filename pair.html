...
<head>
  ...
  <title>ZANTA XMD PAIR CODE</title>
  ...
  <style>
    body {
      ...
      height: 100vh;
      margin: 0;
      background-image: url("https://ibb.co/R4VdX2Cj"); /* Set the background image */
        ...
        <div id="text">
          ...
          <p>
            ...
            <div class="input-container">
              <input placeholder="+94760879639" type="number" id="number" placeholder="⚙enter your phone number with country code⚙" name="">
